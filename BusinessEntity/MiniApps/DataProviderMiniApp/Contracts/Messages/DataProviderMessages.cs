...
public sealed record GetBusinessEntityDataVersionRequest(Guid RequestId, Guid BusinessEntityId, int Version);
public sealed record GetBusinessEntityDataVersionResponse(Guid RequestId, string? Data, int Version = 1, string? ErrorMessage = null);
...
public sealed record UpdateBusinessEntityDataVersionDescriptionRequest(Guid RequestId, Guid BusinessEntityId, int Version, string? VersionDescription);
public sealed record UpdateBusinessEntityDataVersionDescriptionResponse(Guid RequestId, bool Success, string? ErrorMessage = null);
...
public sealed record UpdateBusinessEntityDataRequest(Guid RequestId, Guid BusinessEntityId, string Data, bool HasVersions = false, Guid? LastModifiedByUserId = null);
